...
# GNU Radio version: v3.11.0.0git-923-g4722ef5b
...
class L1_HelloWorld(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        ...
        self.settings = Qt.QSettings("gnuradio/flowgraphs", "L1_HelloWorld")
    ...
    def set_samp_rate(self, samp_rate):
        ...
        self.qtgui_freq_sink_x_0.set_frequency_range(97.9e6, self.samp_rate)
...
def main(top_block_cls=L1_HelloWorld, options=None):
